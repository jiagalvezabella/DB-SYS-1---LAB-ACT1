...
ORDER BY salary;
 61 changes: 61 additions & 0 deletions61  
   ...
   scalar_functions/PROBLEM_02_Scalar.sql
...
33 changes: 33 additions & 0 deletions33  
   ...
   scalar_functions/PROBLEM_03_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,33 @@
USE LUBGUBAN_DB;
...
ORDER BY 4;
 60 changes: 60 additions & 0 deletions60  
   ...
   scalar_functions/PROBLEM_04_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,60 @@
USE LUBGUBAN_DB;
...
ORDER BY 3 DESC;
 20 changes: 20 additions & 0 deletions20  
   ...
   scalar_functions/PROBLEM_05_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,20 @@
USE LUBGUBAN_DB;
...
ORDER BY 1;
 29 changes: 29 additions & 0 deletions29  
   ...
   scalar_functions/PROBLEM_06_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,29 @@
USE LUBGUBAN_DB;
...
ORDER BY 1;
 49 changes: 49 additions & 0 deletions49  
   ...
   scalar_functions/PROBLEM_07_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,49 @@
USE LUBGUBAN_DB;
...
ORDER BY 5, 1;
 ...
 44 changes: 44 additions & 0 deletions44  
   ...
   scalar_functions/PROBLEM_08_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,44 @@
USE LUBGUBAN_DB;
...
ORDER BY 1, 2;
 ...
 40 changes: 40 additions & 0 deletions40  
   ...
   scalar_functions/PROBLEM_09_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,40 @@
USE LUBGUBAN_DB;
...
ORDER BY 1;
 40 changes: 40 additions & 0 deletions40  
   ...
   scalar_functions/PROBLEM_10_Scalar.sql
Original file line number	Original file line	Diff line number	Diff line change
@@ -0,0 +1,40 @@
USE LUBGUBAN_DB;
